...
<div class="main-wrapper">
    ...
    <div class="container-xl">
        <div class="row">
            ...
            <div class="col-lg-12 flex-grow-1 min-h-430">
                <div class=" mt-3 productautoplay home_product_shadwo py-2">
    ...
    <div class="container-xl">
        ...
        <div class="category_products category_radias py-3 text-center">
            ...
            <div class="mt-3 categoryautoplay home_product_shadwo">
        ...
        <div class="category_products py-4 text-center">
            ...
            <div class=" mt-3 bannerautoplay home_product_shadwo ">
        ...
        <div class="category_products py-4 text-center">
            ...
            <div class=" mt-3 bannerautoplay home_product_shadwo py-2">
        ...
        @foreach ($categorys as $category)
            ...
            @if ($categoryProducts->isNotEmpty())
                <div class="category_products py-3">
                    <div class="rounded-2 style2 d-flex justify-content-center align-items-center header_bg">
                        <div class="text-center">
                            <div class="title"><h3>{{ $category->name }}</h3></div>
                        </div>
                        <div class="right pe-lg-5 pe-3 gap-2">
                            {{-- Add a "See All" link or button if needed --}}
                            {{-- <a href="{{ route('category.show', $category->id) }}" class="btn btn-light">See All</a> --}}
                        </div>
                    </div>

                    <div class=" mt-3 bannerautoplay row home_product_shadwo py-2">
